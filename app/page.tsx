            ...
            <div className="space-y-4 max-w-sm mx-auto">
              ...
              <SignInButton mode="modal" forceRedirectUrl="/" signUpForceRedirectUrl="/">
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full border-2 border-border text-foreground hover:bg-accent/50 px-8 py-4 text-lg font-medium rounded-xl transition-all duration-200 bg-background flex items-center gap-3"
                >
