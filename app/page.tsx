              ...
              <Card className="p-8 elevation-2 gradient-card border border-border rounded-2xl">
                <div className="text-center">
                  ...
                  <SignInButton mode="modal" forceRedirectUrl="/" signUpForceRedirectUrl="/">
                    <Button
                      size="lg"
                      className="gradient-primary hover:opacity-90 text-primary-foreground h-14 text-lg font-semibold elevation-2 transition-elevation hover:elevation-3 rounded-xl w-full mb-4"
                    >
                  ...
                  <SignInButton mode="modal" forceRedirectUrl="/" signUpForceRedirectUrl="/">
                    <Button
                      variant="outline"
                      size="lg"
                      className="border-2 border-border hover:bg-accent/5 h-14 text-lg font-medium transition-all duration-200 rounded-xl w-full flex items-center justify-center gap-3 bg-transparent"
                    >
