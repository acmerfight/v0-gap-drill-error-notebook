...
export const translations: Record<string, Translations> = {
  zh: {
    ...
    heroSubtitle:
      '基于超强AI技术，收集分析错题，解析真正不会的知识点，生成针对性练习题，告别无效练习',
    coreValueTitle: '核心价值',
    coreValueDesc:
    ...
    aiPoweredDesc:
      '采用最先进的人工智能技术，识别准确率高达95%以上，支持手写和印刷体',
    targetedLearningTitle: '针对性学习',
    targetedLearningDesc:
      '精准分析知识薄弱点，避免盲目刷题，让每次练习都有针对性',
    efficientPracticeTitle: '高效练习',
    efficientPracticeDesc:
      '告别大量无效练习，专注于真正需要提升的知识点，学习效率翻倍',
  ...
  en: {
    ...
    step1Desc:
      'Take photos or upload error images, AI automatically recognizes question content and solution process',
    step2Title: 'Smart Analysis',
    step2Desc:
      'AI deeply analyzes errors, identifies real knowledge gaps and weak points',
    step3Title: 'Targeted Practice',
    step3Desc:
      'Generate personalized exercises based on analysis results, precisely improve learning effectiveness',
    ...
    targetedLearningDesc:
      'Precisely analyze knowledge weaknesses, avoid blind practice, make every exercise targeted',
    ...
    aiRecognitionSubtitle:
      'Take photos to upload errors, AI recognizes instantly, double learning efficiency',
    uploadTitle: 'Upload Error Image',
    uploadSubtitle:
      'Drag image here, or click button below\nSupports handwriting and print, 95%+ accuracy',
    ...
    markdownSyntax:
      '**Bold**, *Italic*, `Code`, Math formulas $x^2$ or $$\\frac{1}{2}$$',
